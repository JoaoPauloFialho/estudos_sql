from geradorScripts import gerarInsert
...
if(__name__ == "__main__"):
    ...
    for i in range(QUANTIDADE_INSERTS):
        ...
        VALUES = [geradorCpf("str"), pegarDadoAletorioLista(MATRICULA), gerarDataVenda(), gerarInteiros(1, 20), gerarFloats(10.00, 10000.00)];
